...
<div class="card card-custom p-3 mt-4">
  <h5 class="mb-3">📊 Employee Work Summary</h5>
    ...
    <table class="table table-hover align-middle text-center">
      ...
      <tbody>
        <tr>
          ...
          <td class="text-success fw-semibold">24</td>
          <td class="text-danger fw-semibold">2</td>
          <td>208 hrs</td>
          <td>196 hrs</td>
          <td>
        ...
        <tr>
          ...
          <td>Priya Sharma</td>
          <td>HR Manager</td>
          <td class="text-success fw-semibold">26</td>
          <td class="text-danger fw-semibold">0</td>
          <td>208 hrs</td>
          <td>208 hrs</td>
          <td>
        ...
        <tr>
          ...
          <td class="text-success fw-semibold">22</td>
          <td class="text-danger fw-semibold">4</td>
          <td>208 hrs</td>
          <td>172 hrs</td>
          <td>
        ...
        <tr>
          ...
          <td class="text-danger fw-semibold">6</td>
          <td>208 hrs</td>
          <td>160 hrs</td>
          <td>
